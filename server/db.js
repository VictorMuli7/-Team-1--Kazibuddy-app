...
function seedIfNeeded() {
  ...
  const users = [
    ...
    { id: "u-a2", role: "artisan", fullname: "Peter Kamau", email: "peter.kamau@example.com", phone: "+254 711 000 004", password_hash: hash("Peter123!"), status: "pending", joined: "2025-06-20", skill: "Plumbing", verified: 0, bio: "Pipe installation, leak repairs and blockages.", rate: "From KES 700/hr" },
    { id: "u-a3", role: "artisan", fullname: "Mercy Achieng", email: "mercy.a@example.com", phone: "+254 722 000 005", password_hash: hash("Mercy123!"), status: "active", joined: "2024-11-05", skill: "Electrical", verified: 1, bio: "Licensed electrician, wiring and fault-finding.", rate: "From KES 500/hr" },
    { id: "u-c2", role: "customer", fullname: "Samuel Njoroge", email: "samuel.n@example.com", phone: "+254 733 000 006", password_hash: hash("Samuel123!"), status: "active", joined: "2025-01-18", skill: null, verified: 0, bio: null, rate: null },
    { id: "u-c3", role: "customer", fullname: "Lucy Wambui", email: "lucy.w@example.com", phone: "+254 744 000 007", password_hash: hash("Lucy123!"), status: "suspended", joined: "2025-04-09", skill: null, verified: 0, bio: null, rate: null },
  ];

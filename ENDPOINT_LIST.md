...
|--------|------|---------|--------------|
| GET | /artisans | Return verified artisans and their services; supports filtering via query params  | Team 2 needs to read verified artisans and their services |
...
| GET | /bookings | Return bookings, filterable by status  to identify artisans who agreed to a job | Team 2 needs to identify workers who agreed to perform services |
